...
- `src/git_recap/api/app.py` — FastAPI app. Routes in `api/routes/`. `StaticFiles` mount for `frontend/`. Registers routers: pipeline, fetch, normalize, summarize_pipeline, summary, query.
